...
namespace MyApp
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //debtors.Print();
            //task 2
            //debtors.Where(s => s.Email.EndsWith("@jourrapide.com")).ToList().Print();
            //debtors.Where(s => s.Email.EndsWith("@dayrep.com")).ToList().Print();
            /////////////////////////////////////////////////////////////////////////////
            //task 3
            ////////////////////////
            //  debtors.Where(s => DateTime.Now.Year - s.BirthDay.Year >= 26&&DateTime.Now.Year - s.BirthDay.Year < 36).ToList().Print();
            //task 4
            /////////////////////
            // debtors.Where(s => s.Debt<=5000).ToList().Print();
            //task 5
            ////////////////////
            //debtors.Where(s => s.FullName.Length>18)
            //   .Where(s => s.Phone.Count(c => c == '7')>=2)
            //   .ToList().Print();
            // task 7
            ////////////////////////
            // debtors.Where(s => s.BirthDay.Month >= 2).Where(s => s.BirthDay.Month == 12).ToList().Print();
            //task 8
            /////////////////////////////////
            //decimal deb = debtors.Sum(s => s.Debt);
            //debtors.Where(s => s.Debt < deb).OrderBy(s=>s.FullName.Split(" ")[2]).OrderByDescending(s=>s.Debt).ToList().Print();
            //task 9
            //////////////////////////////////////////////////////
           ...
           // debtors.Where(s=> s.FullName.stringfoar(2)).ToList().Print();
            ...
            //{
            //   int number2 = debtors.Count(s=> s.BirthDay.Year==item.BirthDay.Year);
            //    if (number2 >= number)
            //    {
            //        datetime = item.BirthDay.Year;
            //        number = number2;
            //    }
            //}
            //Console.WriteLine(datetime);
            //task 14
            //debtors.OrderBy(s => s.Debt).Take(5).ToList().Print();
            // task 15
            //Console.WriteLine($"Sum: {debtors.Sum(s => s.Debt)}");
            //task 16
            ...
            //    {
            //        if ((item.FullName.Count(s => s == item2)) == 0) { isokay = false; break; }
            //    }
